...
namespace ProteinProAPI.Migrations
{
    ...
    [Migration("20251007191453_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProteinProAPI.Models.ProductSubCategories", b =>
                {
            ...
            modelBuilder.Entity("ProteinProAPI.Models.SubCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProteinProAPI.Models.SubCategoryCategories", b =>
                {
                    b.Property<int>("SubCategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProteinProAPI.Models.ProductSubCategories", b =>
                {
                    b.HasOne("ProteinProAPI.Models.Product", "Product")
                        .WithMany("ProductSubCategories")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProteinProAPI.Models.SubCategory", "SubCategory")
                        .WithMany("ProductSubCategories")
